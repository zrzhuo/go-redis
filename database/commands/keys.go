...
func init() {
	database.RegisterCommand("Exists", execExists, readAllKeys, -2, database.ReadOnly)
	database.RegisterCommand("Del", execDel, writeAllKeys, -2, database.ReadWrite)
	database.RegisterCommand("Expire", execExpire, writeFirstKey, 3, database.ReadWrite)
	database.RegisterCommand("ExpireAt", execExpireAt, writeFirstKey, 3, database.ReadWrite)
